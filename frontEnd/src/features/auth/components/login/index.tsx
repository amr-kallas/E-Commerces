    ...
    return (
        <Container>
          ...
          >
            <Paper
              sx={{
                backgroundImage: {xs:``,sm:`linear-gradient(100deg, rgb(255, 255, 255)49.9%,transparent 50%),url(${greenland})`},
                width: 1,
                minHeight: 450,
                borderRadius: "12px",
            ...
            >
              ...
              >
                ...
                <Submit sx={{ width: "60%" }} isLoading={login.isLoading} >Submit</Submit>
                {login.isError&&(<Alert severity="error">Email or Password not valid</Alert>)}
              </Stack>
            </Paper>
          </Stack>
        </Container>
